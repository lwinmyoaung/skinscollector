            ...
            <div class="carousel-inner">
                @foreach($advertiseSlides as $i => $slidePath)
                    <div class="carousel-item {{ $i === 0 ? 'active' : '' }}">
                        <img src="{{ asset('storage/'.$slidePath) }}" class="d-block w-100" alt="Promotion banner {{ $i + 1 }}" loading="lazy">
                    </div>
                @endforeach
            </div>
    ...
    <div class="products-grid-container">
        ...
        <div class="game-products-grid">
            ...
            <div class="game-product-card" style="--card-index: 0">
                ...
                <div class="product-image-container">
                    <a href="{{ route('mlproducts') }}">
                        <img src="{{ asset('storage/' . ($gameImages->get('mlbb')?->image_path ?? 'photo/sora.jpg')) }}" 
            ...
            <div class="game-product-card" style="--card-index: 1">
                ...
                <div class="product-image-container">
                    <a href="{{ route('mcgg') }}">
                        <img src="{{ asset('storage/' . ($gameImages->get('mcgg')?->image_path ?? 'photo/mcgg.jpg')) }}" 
            ...
            <div class="game-product-card" style="--card-index: 2">
                ...
                <div class="product-image-container">
                    <a href="{{ route('pubg') }}">
                        <img src="{{ asset('storage/' . ($gameImages->get('pubg')?->image_path ?? 'photo/pubg.jpg')) }}" 
            ...
            <div class="game-product-card" style="--card-index: 3">
                ...
                <div class="product-image-container">
                    <a href="{{ route('wwm') }}">
                        <img src="{{ asset('storage/' . ($gameImages->get('wwm')?->image_path ?? 'photo/wwm.jpg')) }}" 
