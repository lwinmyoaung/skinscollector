...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form action="{{ route('admin.kpay.orders') }}" method="GET" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <a href="{{ route('admin.kpay.orders') }}" class="btn btn-outline-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @include('admin.partials.kpay_orders_table')
                    </tbody>
                </table>
            </div>
...
<div class="modal fade" id="cleanupModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.kpay.orders.delete_old') }}" method="POST">
                @csrf
                @method('DELETE')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fetchOrders() {
            ...
            const fetchUrl = new URL("{{ route('admin.kpay.orders.fetch') }}");
